...
export default function TestPage() {
  ...
  const handleStartTest = () => {
    setIsLoading(true);
    router.push(`/test/${domain.id}/level/${nextLevel}`);
  };
  ...
  return (
    <div className="container mx-auto max-w-2xl flex flex-col items-center justify-center h-full text-center animate-in fade-in-50">
        ...
        <Button size="lg" className="w-full max-w-xs" onClick={handleStartTest} disabled={isLoading}>
            {isLoading ? (
                <>
